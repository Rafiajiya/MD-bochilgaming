...
class Aksara {
    ...
    GetShift(str1) {
        var str = str1.toLowerCase(); //case insensitive
    ...
    GetSound(str) {
        ...
        if (str.length == 1)
            ...
            var core_sound = this.GetCoreSound(str);
    ...
    toLatin() {
        ...
        const capitalize = (index, character, str) => str.charAt(0).toUpperCase() + str.slice(1);
        var trans = this.str;
