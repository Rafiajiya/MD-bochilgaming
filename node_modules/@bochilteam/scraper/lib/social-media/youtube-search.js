...
export default async function youtubeSearch(query) {
    ...
    sc.contents.twoColumnSearchResultsRenderer.primaryContents
        .sectionListRenderer.contents[0].itemSectionRenderer.contents.forEach((v, i) => {
        ...
        if (isVideo) {
            let view = ((_a = result.viewCountText) === null || _a === void 0 ? void 0 : _a.simpleText) ||
                ((_b = result.shortViewCountText) === null || _b === void 0 ? void 0 : _b.simpleText) ||
                ((_d = (_c = result.shortViewCountText) === null || _c === void 0 ? void 0 : _c.accessibility) === null || _d === void 0 ? void 0 : _d.accessibilityData.label), _duration = (_f = (_e = result.thumbnailOverlays) === null || _e === void 0 ? void 0 : _e.find((v) => Object.keys(v)[0] === "thumbnailOverlayTimeStatusRenderer")) === null || _f === void 0 ? void 0 : _f.thumbnailOverlayTimeStatusRenderer.text, videoId = result.videoId, duration = ((_g = result.lengthText) === null || _g === void 0 ? void 0 : _g.simpleText) || (_duration === null || _duration === void 0 ? void 0 : _duration.simpleText), durationS = 0;
        ...
        if (isChannel) {
            const channelId = result.channelId, _subscriber = ((_2 = result.subscriberCountText) === null || _2 === void 0 ? void 0 : _2.accessibility.accessibilityData.label) ||
