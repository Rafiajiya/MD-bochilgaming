...
export async function facebookdlv2(url) {
    ...
    const html = (_h = (_g = (_f = (_e = (_d = (_c = decode === null || decode === void 0 ? void 0 : decode.split('("download-section").innerHTML = "')[1]) === null || _c === void 0 ? void 0 : _c.split('; parent.document.getElementById("inputData").remove();')[0]) === null || _d === void 0 ? void 0 : _d.split('</style><section class=')[1].split('"> ')) === null || _e === void 0 ? void 0 : _e.slice(1)) === null || _f === void 0 ? void 0 : _f.map(v => (v + '">').trim()).join()) === null || _g === void 0 ? void 0 : _g.split('</section><div class=')[0]) === null || _h === void 0 ? void 0 : _h.replace(/\\(\\)?/g, '');
    let result = [];
    ...
    if (!result.length)
        throw new ScraperError(`Can't download!\n${$.html()}`);
    return {
        id: ((_k = (_j = $("div.media-content > div.content > p > strong")
            .text()
            .split("#")) === null || _j === void 0 ? void 0 : _j[1]) === null || _k === void 0 ? void 0 : _k.trim()) || '',
...
export async function facebookdlv3(url) {
    ...
    const thumbnail = /background-image: url\((.*?)\);/i.exec(row.eq(0).find('a[href]').attr('style'))[1];
    const result = [];
